...
begin
  TSgLib.Check;
  TSgLib.CheckLastError(sg_httpauth_set_realm(FHandle, M.ToCString(AValue)));
end;
...
begin
  TSgLib.Check;
  TSgLib.CheckLastError(sg_httpauth_deny2(FHandle, M.ToCString(AReason),
...
begin
  TSgLib.Check;
  TSgLib.CheckLastError(sg_httpauth_deny(FHandle, M.ToCString(AReason),
...
begin
  TSgLib.Check;
  TSgLib.CheckLastError(sg_httpauth_cancel(FHandle));
end;
