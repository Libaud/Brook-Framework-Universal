...
{$ENDIF}
  ...
  SysUtils, BrookApplicationInterfaces;
...
function TBrookDaemonApplication.GetTitle: string;
begin

end;

procedure TBrookDaemonApplication.SetTitle(const aTitle: string);
begin
